                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6" style="overflow:auto;">
                                ...
                                <div class="single-slider-resto mb-4 mb-md-0 owl-carousel">
                                    <div class="item">
                                        <a href="http://localhost:${port}/1/search/${cid}/detail"><div class="resto-img" style="background-image: url(/engimage/${cid}.jpg); background-repeat: no-repeat; background-size: contain;"></div></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col-md-6 pl-md-5">
                                                <div class="heading-section mb-4 my-5 my-md-0">
                                                    <h4 class="mb-4">${des_name}
                                                        ...
                                                        <span class="flaticon-speaker detailheart" onclick="docente()" style="cursor:hand">
                                                            <audio id= "audio" >
                                                                <source src="/engdocoente/${cid}.mp3" type="audio/mp3"/>
                                                            </audio>
                                                        </span>
                                                    </h4>
                                                </div>
